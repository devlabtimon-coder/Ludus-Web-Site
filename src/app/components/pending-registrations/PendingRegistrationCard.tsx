...
export function PendingRegistrationCard({
  ...
  return (
    <div
      onClick={onSelect}
      className={`bg-[#F8F9FA] rounded-xl p-3 sm:p-4 border-l-4 ${getBorderColor()} cursor-pointer transition-all ${
    ...
    >
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex flex-col gap-1.5 mt-2">
            <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
              ...
              {user.cpf && (
                <span className="flex items-center gap-1 text-xs text-gray-600 font-medium border-l border-gray-300 pl-2 sm:pl-3">
      ...
      <div className="flex gap-1.5 mt-3 pt-3 border-t border-gray-200 overflow-x-auto pb-1 scrollbar-hide">
        {isIfmaMode ? (
          <>
